...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="State Machine" Type="Folder">
			...
			<Item Name="Python Version.ctl" Type="VI" URL="../lock-box.llb/Python Version.ctl"/>
			<Item Name="Python File Paths.ctl" Type="VI" URL="../lock-box.llb/Python File Paths.ctl"/>
